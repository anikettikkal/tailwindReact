...
export default function Contact() {
    return (
        <div className="relative flex items-top justify-center pt-20 pb-20 mb-auto  w-full overflow-hidden bg-gradient-to-br from-indigo-50 to-white font-sans">
                ...
                <div className="mt-8 overflow-hidden">
                    <div className="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <form action="" method="POST" className="p-6 flex flex-col justify-center">
                            ...
                            <button
                                type="submit"
                                className="md:w-32 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-bold py-3 px-6 rounded-lg mt-3 hover:bg-orange-600 transition ease-in-out duration-300"
                            >
                                Submit
                            </button>
                        </form>
